...
/*
    ...
    case PPC_INST_VAVGUH:
        println("\tsimde_mm_store_si128((simde__m128i*){}.u16, _mm_avg_epu16(simde_mm_load_si128((simde__m128i*){}.u16), simde_mm_load_si128((simde__m128i*){}.u16)));",
    ...
    case PPC_INST_VCMPBFP128:
        printSetFlushMode(true);
        println("\tsimde_mm_store_ps({}.f32, _mm_vcmpbfp(_mm_load_ps({}.f32), simde_mm_load_ps({}.f32)));",
            v(insn.operands[0]), v(insn.operands[1]), v(insn.operands[2]));
        if (strchr(insn.opcode->name, '.'))
    ...
    case PPC_INST_VMAXSH:
        println("\tsimde_mm_store_si128((simde__m128i*){}.s16, _mm_max_epi16(simde_mm_load_si128((simde__m128i*){}.s16), simde_mm_load_si128((simde__m128i*){}.s16)));",
            v(insn.operands[0]), v(insn.operands[1]), v(insn.operands[2]));
        break;
    ...
    case PPC_INST_VMAXUH:
        println("\tsimde_mm_store_si128((simde__m128i*){}.u16, _mm_max_epu16(simde_mm_load_si128((simde__m128i*){}.u16), simde_mm_load_si128((simde__m128i*){}.u16)));",
            v(insn.operands[0]), v(insn.operands[1]), v(insn.operands[2]));
        break;
    ...
    case PPC_INST_VMINSH:
        println("\tsimde_mm_store_si128((simde__m128i*){}.s16, _mm_min_epi16(simde_mm_load_si128((simde__m128i*){}.s16), simde_mm_load_si128((simde__m128i*){}.s16)));",
            v(insn.operands[0]), v(insn.operands[1]), v(insn.operands[2]));
        break;


    case PPC_INST_VMINUH:
        println("\tsimde_mm_store_si128((simde__m128i*){}.u16, _mm_min_epu16(simde_mm_load_si128((simde__m128i*){}.u16), simde_mm_load_si128((simde__m128i*){}.u16)));",
            v(insn.operands[0]), v(insn.operands[1]), v(insn.operands[2]));
        break;
    ...
    case PPC_INST_VNOR128:
        println("\tsimde_mm_store_si128((simde__m128i*){}.u8, _mm_xor_si128(_mm_or_si128(simde_mm_load_si128((simde__m128i*){}.u8), simde_mm_load_si128((simde__m128i*){}.u8)), _mm_set1_epi32(-1)));",
            v(insn.operands[0]), v(insn.operands[1]), v(insn.operands[2]));
        break;
    ...
    case PPC_INST_VPKSHSS128:
        println("\tsimde_mm_store_si128((simde__m128i*){}.s8, _mm_packs_epi16(simde_mm_load_si128((simde__m128i*){}.s16), simde_mm_load_si128((simde__m128i*){}.s16)));",
    ...
    case PPC_INST_VPKSWSS128:
        println("\tsimde_mm_store_si128((simde__m128i*){}.s16, _mm_packs_epi32(simde_mm_load_si128((simde__m128i*){}.s32), simde_mm_load_si128((simde__m128i*){}.s32)));",
            v(insn.operands[0]), v(insn.operands[2]), v(insn.operands[1]));
        break;
    ...
    case PPC_INST_VPKSWUS128:
        println("\tsimde_mm_store_si128((simde__m128i*){}.s32, simde_mm_load_si128((simde__m128i*){}.s32));", vTemp(), v(insn.operands[2]));
        for (int i = 0; i < 4; i++) {
            println("\t{}.u16[{}] = {}.s32[{}] < 0 ? 0 : ({}.s32[{}] > 0xFFFF ? 0xFFFF : {}.s32[{}]);",
                v(insn.operands[0]), i, vTemp(), i, vTemp(), i, vTemp(), i);
        }
        println("\tsimde_mm_store_si128((simde__m128i*){}.s32, simde_mm_load_si128((simde__m128i*){}.s32));", vTemp(), v(insn.operands[1]));
        for (int i = 0; i < 4; i++) {
            println("\t{}.u16[{}] = {}.s32[{}] < 0 ? 0 : ({}.s32[{}] > 0xFFFF ? 0xFFFF : {}.s32[{}]);",
    ...
    case PPC_INST_VPKUHUS128:
        ...
        println("\tsimde_mm_store_si128((simde__m128i*){}.u8, _mm_packus_epi16(simde_mm_load_si128((simde__m128i*){}.u16), simde_mm_load_si128((simde__m128i*){}.u16)));",
            v(insn.operands[0]), v(insn.operands[2]), v(insn.operands[1]));
        break;
    ...
    case PPC_INST_VPKUWUM128:
        println("\tsimde_mm_store_si128((simde__m128i*){}.u32, simde_mm_load_si128((simde__m128i*){}.u32));", vTemp(), v(insn.operands[2]));
        for (int i = 0; i < 4; i++) {
            println("\t{}.u16[{}] = {}.u16[{}];",
                v(insn.operands[0]), i, vTemp(), i * 2);
        }
        println("\tsimde_mm_store_si128((simde__m128i*){}.u32, simde_mm_load_si128((simde__m128i*){}.u32));", vTemp(), v(insn.operands[1]));
        for (int i = 0; i < 4; i++) {
            println("\t{}.u16[{}] = {}.u16[{}];",
    ...
    case PPC_INST_VSPLTISH:
        println("\tsimde_mm_store_si128((simde__m128i*){}.s16, _mm_set1_epi16(short({})));",
    ...
    case PPC_INST_VSUBSHS:
        println("\tsimde_mm_store_si128((simde__m128i*){}.s16, _mm_subs_epi16(simde_mm_load_si128((simde__m128i*){}.s16), simde_mm_load_si128((simde__m128i*){}.s16)));",
            v(insn.operands[0]), v(insn.operands[1]), v(insn.operands[2]));
        break;
	...
	case PPC_INST_VSRO128:
		printSetFlushMode(true);
		// shift amt: high bits (>>3) give bytes (per spec: low 7 bits used; high 4 bits = bytes)
		println("\tsimd::vec128i shift_amt = simd::srli_i16({}.v128, 3);", v(insn.operands[2]));
		println("\tint shift = simd::extract_u8(shift_amt, 15) & 0x1F;");
		println("\tif (shift >= 16) {{");
		println("\t\t{}.v128 = simd::zero_i128();", v(insn.operands[0]));
		println("\t}} else {{");
		// shift right by 'shift' bytes: alignr(src, zero, shift)
		println("\t\t{}.v128 = simd::alignr_i8({}.v128, simd::zero_i128(), shift);", v(insn.operands[0]), v(insn.operands[1]));
		println("\t}}");
		break;
	...
	case PPC_INST_VRFIP128:
		printSetFlushMode(true);
		println("\tsimde_mm_store_ps({}.f32, simde_mm_round_ps(simde_mm_load_ps({}.f32), _MM_FROUND_TO_POS_INF | _MM_FROUND_NO_EXC));",
				v(insn.operands[0]), v(insn.operands[1]));
		break;


	case PPC_INST_VCMPGTUW:
		// compare unsigned 32-bit greater-than:
		// map unsigned -> signed space by XOR with 0x80000000, luego signed compare
		println("\tsimd::store_u32({}.u32, simd::cmpgt_i32(simd::xor_i32(simd::load_u32({}.u32), simd::set1_i32(0x80000000)), simd::xor_i32(simd::load_u32({}.u32), simd::set1_i32(0x80000000))));",
				v(insn.operands[0]), v(insn.operands[1]), v(insn.operands[2]));
		if (strchr(insn.opcode->name, '.'))
			println("\t{}.setFromMask(simd::load_u32({}.u32), 0xFFFF);", cr(6), v(insn.operands[0]));
		break;


	case PPC_INST_VSUBUWM:
		println("\tsimd::store_u32({}.u32, simd::sub_i32(simd::load_u32({}.u32), simd::load_u32({}.u32)));",
				v(insn.operands[0]), v(insn.operands[1]), v(insn.operands[2]));
		break;
